...
static const ExplainInfo explain_infos[] = {
  ...
  },
  {
    ...
    "parser",
    "Parser syntax error",
    "The input contained malformed Zero syntax that the parser could not understand.",
    "Zero parses source and manifest files with a strict syntax model, so missing delimiters, unmatched parentheses, and invalid constructs stop the compiler before further checking.",
    "Repair the syntax at the reported parser span, then rerun zero check.",
  ...
  },
  {
    ...
    "name",
    "Unknown identifier",
    "The compiler encountered an undefined name in source code, such as a misspelled symbol, missing declaration, or missing import.",
    "Zero keeps names explicit; every referenced symbol must be declared or imported before use.",
